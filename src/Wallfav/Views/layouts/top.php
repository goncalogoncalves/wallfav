...
<head>
    ...
    <meta name="copyright" content="wallfav">
    ...
    <meta name="apple-mobile-web-app-title" content="wallfav">
    ...
    <meta name="og:image" content="http://www.wallfav.com/img/logo_wallfav.png">
    <meta name="og:site_name" content="<?php echo $array_global_configs['website_titulo']; ?>">
    ...
    <meta name="application-name" content="wallfav">
    ...
    <link rel="stylesheet" href="<?php echo BASE_URL;?>dist/todos2.min.css">
